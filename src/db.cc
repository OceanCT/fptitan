...
bool TitanDB::GCInProgress(ColumnFamilyHandle* handle) {
	return ((TitanDBImpl*)this)->GCInProgress(handle);
}

std::string TitanDB::GetFPInfo(ColumnFamilyHandle* handle) {
	return ((TitanDBImpl*)this)->GetFPInfo(handle);
}
