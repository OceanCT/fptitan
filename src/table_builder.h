...
class TitanTableBuilder : public TableBuilder {
 ...
 private:
  ...
  void AddBlob(const ParsedInternalKey& ikey, const Slice& value, bool addFP=true);
  ...
  void AddFP(std::string key, FPFeatures features, BlobIndex blob_index);
